    ...
    <div className="min-h-screen bg-[#0B0B0D] text-white flex flex-col selection:bg-[#6366F1]/30 selection:text-white">
      ...
      <section id="downloader" className="relative py-14 sm:py-20 lg:py-24 px-4 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-4xl text-center">
          ...
          {/* Downloader Card: Highlighted with dynamic ambient neon glow */}
          <div className="relative mt-8 group">
            {/* Ambient Multi-Color Neon Glow Backdrop */}
            <div className="absolute -inset-1 rounded-3xl bg-gradient-to-r from-[#6366F1] via-[#A855F7] to-[#EC4899] opacity-75 blur-xl group-hover:opacity-100 transition duration-500 animate-pulse pointer-events-none" />

            <div className="relative rounded-2xl border-2 border-[#6366F1]/50 bg-[#141416]/95 backdrop-blur-xl p-4 sm:p-6 shadow-[0_0_50px_rgba(99,102,241,0.3)] text-left">
              <label
                htmlFor="insta-url"
              ...
              <form onSubmit={handleAnalyze} className="flex flex-col sm:flex-row gap-3">
                <div className="relative flex-1">
                  <input
                    ...
                    className="w-full h-[54px] rounded-xl border-2 border-[#6366F1]/60 bg-[#0B0B0D] px-4 pr-10 text-sm sm:text-base text-white placeholder:text-[#A1A1AA]/60 outline-none focus:border-[#818CF8] focus:ring-4 focus:ring-[#6366F1]/30 shadow-[inset_0_2px_4px_rgba(0,0,0,0.6),0_0_25px_rgba(99,102,241,0.25)] transition duration-200"
                  />
                  {url ? (
                    <button
                      type="button"
                ...
                <button
                  type="submit"
                  disabled={loading}
                  className="h-[54px] px-8 rounded-xl bg-gradient-to-r from-[#6366F1] to-[#8B5CF6] hover:from-[#4F46E5] hover:to-[#7C3AED] text-white font-semibold text-base transition flex items-center justify-center gap-2 shadow-[0_0_25px_rgba(99,102,241,0.4)] hover:shadow-[0_0_35px_rgba(139,92,246,0.6)] disabled:opacity-60 disabled:cursor-not-allowed shrink-0"
                >
                  {loading ? (
                    <>
      ...
      {/* 7. HOW IT WORKS PIPELINE WITH VISUAL SAMPLES */}
      <section id="how-it-works" className="py-16 sm:py-24 border-t border-[#27272A] px-4 sm:px-6 lg:px-8 bg-[#0E0E11]">
        <div className="mx-auto max-w-6xl">
          <div className="text-center">
            <div className="inline-flex items-center gap-2 rounded-full border border-[#27272A] bg-[#141416] px-3.5 py-1 text-xs font-semibold text-[#6366F1] mb-4">
              <Sparkles className="h-3.5 w-3.5" />
              <span>Step-by-Step Visual Pipeline</span>
            </div>
            <h2 className="text-3xl sm:text-4xl font-extrabold tracking-tight text-white">
              How StealReel works
            </h2>
            <p className="mx-auto mt-3 max-w-xl text-sm sm:text-base text-[#A1A1AA] leading-relaxed">
              Save any public Reel, video, or photo in three easy steps with full quality preservation.
            </p>
          </div>

          <div className="mt-14 grid grid-cols-1 lg:grid-cols-3 gap-8">
            {/* STEP 1: COPY LINK */}
            <div className="rounded-2xl border border-[#27272A] bg-[#141416] p-6 flex flex-col justify-between hover:border-[#6366F1]/40 transition shadow-xl group">
              <div>
                <div className="flex items-center justify-between mb-4">
                  <span className="font-mono text-xs font-extrabold uppercase tracking-wider text-[#6366F1] bg-[#6366F1]/10 px-2.5 py-1 rounded-md border border-[#6366F1]/20">
                    Step 01
                  </span>
                  <span className="text-xs text-[#A1A1AA]">On Instagram</span>
                </div>
                <h3 className="text-xl font-bold text-white">Copy the Reel Link</h3>
                <p className="mt-2 text-xs sm:text-sm text-[#A1A1AA] leading-relaxed">
                  Open the Instagram app or browser, tap the Share icon on any public Reel or post, and tap <strong className="text-white">"Copy link"</strong>.
                </p>

                {/* Visual Sample Mockup: Instagram Reel UI */}
                <div className="mt-6 rounded-xl border border-[#27272A] bg-[#0B0B0D] p-3.5 shadow-inner">
                  {/* Mock Reel Header */}
                  <div className="flex items-center justify-between pb-2.5 border-b border-[#27272A]/70">
                    <div className="flex items-center gap-2">
                      <div className="h-6 w-6 rounded-full bg-gradient-to-tr from-[#F59E0B] via-[#EC4899] to-[#8B5CF6] p-[1.5px]">
                        <div className="h-full w-full rounded-full bg-[#141416]" />
                      </div>
                      <span className="text-[11px] font-semibold text-white">travel.diaries</span>
                    </div>
                    <span className="text-[10px] text-[#A1A1AA] font-mono">Reels</span>
                  </div>

                  {/* Mock Video Viewport */}
                  <div className="relative mt-2.5 h-36 rounded-lg bg-gradient-to-b from-[#1F1D36] via-[#16192E] to-[#0A0D18] flex items-center justify-center overflow-hidden border border-[#27272A]">
                    {/* Simulated visual background */}
                    <div className="absolute inset-0 opacity-40 bg-[radial-gradient(#8B5CF6_1px,transparent_1px)] [background-size:12px_12px]" />
                    <div className="h-10 w-10 rounded-full bg-white/10 backdrop-blur-md flex items-center justify-center text-white shadow-lg">
                      <Play className="h-4 w-4 fill-white ml-0.5" />
                    </div>

                    {/* Right action icons on Reel */}
                    <div className="absolute right-2 bottom-3 flex flex-col items-center gap-2">
                      <div className="flex flex-col items-center">
                        ...
                        <span className="text-[9px] text-white/80 font-mono">142K</span>
                      </div>
                      {/* Highlighted Share Button with Glow Beacon */}
                      <div className="relative flex flex-col items-center">
                        <div className="absolute -inset-1 rounded-full bg-[#6366F1] animate-ping opacity-60" />
                        <div className="relative h-7 w-7 rounded-full bg-[#6366F1] flex items-center justify-center text-white shadow-[0_0_12px_rgba(99,102,241,0.8)]">
                          <Share2 className="h-3.5 w-3.5" />
                        </div>
                        <span className="text-[9px] text-[#818CF8] font-mono font-bold mt-0.5">Share</span>
                      </div>
                    </div>
                  </div>

                  {/* Mock "Share to" bottom sheet highlight */}
                  <div className="mt-2.5 rounded-lg border border-[#6366F1]/40 bg-[#1A1A22] p-2 flex items-center justify-between">
                    <div className="flex items-center gap-2">
                    ...
                    <span className="inline-flex items-center gap-1 rounded bg-[#10B981]/20 px-2 py-0.5 text-[10px] font-bold text-[#10B981]">
              ...
              <div className="mt-6 pt-4 border-t border-[#27272A]/70 flex items-center gap-1.5 text-xs text-[#10B981] font-medium">
                <CheckCircle2 className="h-4 w-4" />
                <span>Supports Reels, Posts, Videos &amp; Stories</span>
              </div>
            </div>
            ...
            <div className="rounded-2xl border border-[#27272A] bg-[#141416] p-6 flex flex-col justify-between hover:border-[#6366F1]/40 transition shadow-xl group">
              <div>
                <div className="flex items-center justify-between mb-4">
                  <span className="font-mono text-xs font-extrabold uppercase tracking-wider text-[#A855F7] bg-[#A855F7]/10 px-2.5 py-1 rounded-md border border-[#A855F7]/20">
                    Step 02
                  </span>
                  <span className="text-xs text-[#A1A1AA]">On StealReel</span>
                </div>
                <h3 className="text-xl font-bold text-white">Paste &amp; Pick Quality</h3>
                <p className="mt-2 text-xs sm:text-sm text-[#A1A1AA] leading-relaxed">
                  Paste the link into StealReel. Our parser instantly resolves the stream and offers <strong className="text-white">Original, 1080p, or 720p</strong>.
                </p>

                {/* Visual Sample Mockup: Glowing StealReel Input & Selector */}
                <div className="mt-6 rounded-xl border border-[#27272A] bg-[#0B0B0D] p-3.5 shadow-inner">
                  {/* Glowing Input Mockup */}
                  <div className="rounded-lg border-2 border-[#6366F1] bg-[#141416] p-2 shadow-[0_0_18px_rgba(99,102,241,0.25)]">
                    <div className="flex items-center gap-2">
                      <span className="text-xs text-[#A1A1AA]">🔗</span>
                      <span className="text-[11px] font-mono text-white/90 truncate flex-1">
                        instagram.com/reel/C8x9...
                      </span>
                      <span className="rounded bg-[#6366F1] px-2 py-1 text-[10px] font-bold text-white shrink-0 shadow">
                        Analyze
                      </span>
                    </div>
                  </div>

                  {/* Resolution Quality Selector Sample */}
                  <div className="mt-3">
                    <div className="text-[10px] font-bold uppercase tracking-wider text-[#A1A1AA] mb-1.5 flex items-center justify-between">
                      <span>Select Resolution:</span>
                      <span className="text-[#10B981] font-semibold text-[9px]">Original Default ✓</span>
                    </div>
                    <div className="grid grid-cols-3 gap-1.5">
                      <div className="rounded-md border-2 border-[#6366F1] bg-[#6366F1]/15 p-1.5 text-center shadow-[0_0_10px_rgba(99,102,241,0.3)]">
                        <div className="text-[11px] font-bold text-white">Original</div>
                        <div className="text-[9px] text-[#A855F7] font-semibold">Best Quality</div>
                      </div>
                      <div className="rounded-md border border-[#27272A] bg-[#1A1A1D] p-1.5 text-center opacity-80">
                        <div className="text-[11px] font-medium text-white">1080p</div>
                        <div className="text-[9px] text-[#A1A1AA]">Full HD</div>
                      </div>
                      <div className="rounded-md border border-[#27272A] bg-[#1A1A1D] p-1.5 text-center opacity-80">
                        <div className="text-[11px] font-medium text-white">720p</div>
                        <div className="text-[9px] text-[#A1A1AA]">HD</div>
                      </div>
                    </div>
                  </div>

                  {/* Verification pill */}
                  <div className="mt-3 flex items-center justify-between text-[10px] text-[#A1A1AA] px-1">
                    <span>✓ No password needed</span>
                    <span>✓ Ultra-fast stream</span>
                  </div>
                </div>
              </div>
              ...
              <div className="mt-6 pt-4 border-t border-[#27272A]/70 flex items-center gap-1.5 text-xs text-[#10B981] font-medium">
                <CheckCircle2 className="h-4 w-4" />
                <span>Original source resolution preserved</span>
              </div>
            </div>
            ...
            <div className="rounded-2xl border border-[#27272A] bg-[#141416] p-6 flex flex-col justify-between hover:border-[#6366F1]/40 transition shadow-xl group">
              <div>
                <div className="flex items-center justify-between mb-4">
                  <span className="font-mono text-xs font-extrabold uppercase tracking-wider text-[#10B981] bg-[#10B981]/10 px-2.5 py-1 rounded-md border border-[#10B981]/20">
                    Step 03
                  </span>
                  <span className="text-xs text-[#A1A1AA]">Direct to Device</span>
                </div>
                <h3 className="text-xl font-bold text-white">Instant Direct Download</h3>
                <p className="mt-2 text-xs sm:text-sm text-[#A1A1AA] leading-relaxed">
                  Hit <strong className="text-white">Download Reel</strong>. Your high-definition video saves immediately to your phone or computer.
                </p>

                {/* Visual Sample Mockup: Download Completion & File Tray */}
                <div className="mt-6 rounded-xl border border-[#27272A] bg-[#0B0B0D] p-3.5 shadow-inner">
                  {/* Media Preview Box */}
                  <div className="flex items-center gap-3 p-2 rounded-lg border border-[#27272A] bg-[#141416]">
                    <div className="relative h-12 w-12 rounded-md bg-[#27272A] flex items-center justify-center shrink-0 overflow-hidden">
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="text-[11px] font-semibold text-white truncate">instagram_reel_original.mp4</div>
                      <div className="text-[10px] text-[#10B981] flex items-center gap-1">
                        ...
                        <span>Ready to download (1080p)</span>
                      </div>
                    </div>
                  </div>

                  {/* Primary CTA Button Mockup */}
                  <div className="mt-2.5">
                    <div className="h-9 w-full rounded-lg bg-gradient-to-r from-[#6366F1] to-[#8B5CF6] flex items-center justify-center gap-1.5 text-xs font-bold text-white shadow-[0_0_15px_rgba(99,102,241,0.4)]">
                      <Download className="h-3.5 w-3.5" />
                      <span>Download Reel (Original)</span>
                    </div>
                  </div>

                  {/* Simulated Browser Save Notification */}
                  <div className="mt-2.5 rounded-lg border border-[#10B981]/30 bg-[#10B981]/10 p-2 flex items-center justify-between">
                    <div className="flex items-center gap-1.5">
                      <CheckCircle2 className="h-3.5 w-3.5 text-[#10B981]" />
                      <span className="text-[10px] font-medium text-white">Saved to Downloads folder</span>
                    </div>
                    <span className="text-[9px] font-mono text-[#10B981] font-bold">100%</span>
                  </div>
                </div>
              </div>
              ...
              <div className="mt-6 pt-4 border-t border-[#27272A]/70 flex items-center gap-1.5 text-xs text-[#10B981] font-medium">
                <CheckCircle2 className="h-4 w-4" />
                <span>Zero watermarks &bull; High bitrate</span>
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="border-t border-[#27272A] px-4 py-8 bg-[#0E0E11]">
        <p className="mx-auto max-w-4xl text-center text-xs text-[#A1A1AA]/80 leading-relaxed">
          ...
          copyright laws.{" "}
          <Link to="/responsible-use" className="text-[#6366F1] underline hover:text-white font-medium">
            Read our Responsible Use Guidelines &rarr;
          </Link>
        </p>
      </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-[1.5fr_1fr_1fr_1fr] gap-8 pb-12">
            ...
            <div>
              ...
              <a
                ...
                className="mt-3 inline-flex items-center gap-1.5 text-xs text-[#6366F1] hover:text-[#818CF8] transition font-mono"
              >
                <Mail className="h-3.5 w-3.5" />
                <span>Mail us: info@stealreel.com</span>
              </a>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-2 text-xs text-[#A1A1AA]">
                ...
                <li>
                  <Link to="/contact" className="hover:text-white transition text-[#6366F1] font-medium">
                    Contact &amp; Reach Out
                  </Link>
                </li>
                <li>
                  <a href="mailto:info@stealreel.com" className="hover:text-white transition text-[#A1A1AA]">
                    Mail Us (info@stealreel.com)
                  </a>
                </li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-2 text-xs text-[#A1A1AA]">
                ...
                <li>
                  <Link to="/responsible-use" className="hover:text-white transition">
                    Responsible Use
                  </Link>
                </li>
              </ul>
